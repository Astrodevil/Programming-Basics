...
int sum(node *p)                                 //function to calulate the sum of data of all the nodes of the linked list(by using recursion)
{
    if (p)
...
int main()
{
    ...
    display(head);
    cout << "Sum of all the elements of the linked list is: " << sum(head) << endl;
    return 0;
}